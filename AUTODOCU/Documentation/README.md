...
- [Working with Concept Sets](./4.Working_with_Concept_Sets/README.md): How to build a **Concept Set** from several **Concepts**, including and excluding whole branches of the hierarchy, and pruning the combined view to compare conditions over time.
